...
- **Modo repetir** (VLC + Anytune + Moises): es un modo explícito. Al entrar se ocultan las marcas de notas. El primer toque en la barra pone el inicio, el segundo el fin, y empieza a repetir; el botón grande hace lo mismo con el punto actual del vídeo. Los extremos se arrastran y se ajustan con ±1 s. Se sale con "Salir del modo repetir" o Esc.
